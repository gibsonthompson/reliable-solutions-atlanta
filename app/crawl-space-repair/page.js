  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Service","name":"Crawl Space Repair","description":"Expert crawl space structural repair in Metro Atlanta. Sagging joist repair, wood rot remediation, mold removal, insulation replacement, and moisture damage restoration.","url":"https://www.waterhelpme.com/crawl-space-repair","provider":{"@id":"https://www.waterhelpme.com/#business"},"areaServed":{"@type":"State","name":"Georgia"},"serviceType":"Crawl Space Repair"}) }}
      />
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 pt-12 border-t border-gray-200">
            <h2 className="text-2xl md:text-3xl font-bold text-[#273373] font-display mb-8">Crawl Space Repair Resources</h2>
