...
export default function AdminLayout({ children }) {
  ...
  const navGroups = [
    ...
    { label: 'CRM', items: [
      ...
      { href: '/admin/messaging', label: 'Messaging', perm: 'messaging', icon: <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M3 5a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2h-5l-4 4v-4H5a2 2 0 01-2-2V5z" /></svg> },
