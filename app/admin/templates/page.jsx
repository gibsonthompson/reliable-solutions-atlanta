...
export default function TemplatesPage() {
  ...
  const handleNew = () => {
    setEditing('new')
    setFormData({ name: '', subject: '', body: '', category: 'follow_up', is_default: false })
  }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const url = editing === 'new' ? '/api/admin/templates' : '/api/admin/templates'
  ...
  const getCategoryBadge = (category) => {
    const styles = {
      ...
      post_service: 'bg-green-100 text-green-700',
  ...
  return (
    <div className="px-4 py-4 sm:py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-lg sm:text-2xl font-bold text-[#273373]">Email Templates</h2>
          <p className="text-gray-500 text-xs sm:text-sm">{templates.length} templates</p>
        </div>
        {!editing && (
          <button
            onClick={handleNew}
            className="flex items-center gap-2 px-4 py-2.5 bg-[#115997] text-white text-sm font-medium rounded-xl hover:bg-[#273373] transition-colors active:scale-[0.98]"
          >
      ...
      {editing && (
        <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 mb-6 border-2 border-[#115997]/20">
          <h3 className="font-semibold text-[#273373] mb-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Use {name}, {service_type} for personalization"
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm font-mono focus:ring-2 focus:ring-[#115997] focus:border-transparent outline-none"
              />
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span className="text-[10px] text-gray-400">
                  Variables: {'{name}'} {'{first_name}'} {'{service_type}'} {'{email}'} {'{phone}'}
                </span>
              </div>
              <textarea
                value={formData.body}
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              <button
                ...
                className="flex-1 sm:flex-none px-4 py-2.5 text-sm font-medium text-white bg-[#115997] rounded-lg hover:bg-[#273373] transition-colors disabled:opacity-50"
              >
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        {templates.length === 0 ? (
          <div className="p-8 sm:p-12 text-center">
            ...
            <button onClick={handleNew} className="mt-3 text-sm text-[#115997] font-medium hover:underline">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      <span className={'inline-flex px-2 py-0.5 rounded-full text-[10px] font-medium ' + getCategoryBadge(template.category)}>
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    <button
                      ...
                      className="p-2 text-gray-400 hover:text-[#115997] rounded-lg hover:bg-gray-100 transition-colors"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
