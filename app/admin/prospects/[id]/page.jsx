...
const SOURCE_OPTIONS = [{ value: 'csv_import', label: 'CSV Import' }, { value: 'meta_ads', label: 'Meta Ads' }, { value: 'linkedin', label: 'LinkedIn' }, { value: 'google', label: 'Google Search' }, { value: 'referral', label: 'Referral' }, { value: 'website', label: 'Website' }, { value: 'manual', label: 'Manual' }, { value: 'other', label: 'Other' }]
const SMS_TEMPLATES = [
  { label: 'Intro', text: "Hey {name}, this is Alex from Reliable Solutions Atlanta. We specialize in waterproofing and foundation repair across Metro Atlanta. Would love to help with your project. 770-895-2039" },
  { label: 'Follow up', text: "Hey {name}, just following up on your inquiry. We offer free same-week inspections for any crawl space or foundation concerns. Happy to help. 770-895-2039 - Alex, RSA" },
  { label: 'Thank you', text: "Hey {name}, thanks for reaching out! We'll take great care of your home. Let me know if anything else comes up. 770-895-2039 - Alex, RSA" },
]
...
export default function ProspectDetailPage() {
  ...
  const composerContact = prospect ? { id: prospect.id, name: prospect.name, email: prospect.email || '', phone: prospect.phone || '', service_type: prospect.area || 'General Inquiry' } : null
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div><label className="block text-[10px] text-gray-400 uppercase tracking-widest font-semibold mb-1.5">Company</label><input type="text" value={formData.brokerage} onChange={(e) => setFormData(p => ({ ...p, brokerage: e.target.value }))} placeholder="Company name" className="w-full px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#115997]/20 outline-none transition-all" /></div>
              ...
              <div><label className="block text-[10px] text-gray-400 uppercase tracking-widest font-semibold mb-1.5">Service / Area</label><input type="text" value={formData.area} onChange={(e) => setFormData(p => ({ ...p, area: e.target.value }))} placeholder="Service needed or area" className="w-full px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#115997]/20 outline-none transition-all" /></div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100"><h3 className="font-bold text-gray-900 mb-4 text-sm">Internal Notes</h3><textarea value={formData.notes} onChange={(e) => setFormData(p => ({ ...p, notes: e.target.value }))} rows={4} placeholder="Notes about this contact..." className="w-full px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#115997]/20 outline-none resize-none transition-all" /></div>
