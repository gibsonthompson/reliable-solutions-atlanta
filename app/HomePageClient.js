...
export default function HomePageClient() {
  ...
  const testimonials = [
    ...
    { name: 'Max Povolotsky', text: "Did a wonderful job and I recommended them to my family and friends. I was very happy with Alex's communication and attention to detail at our new home. He came out and provided multiple solutions for the water damage in our basement and explained the scope of work in detail twice to ensure we understood everything. His team knocked it out of the park, treated our home with respect, and made sure everything was cleaned up after the job." },
    { name: 'Mike & Patty Pratt', text: "We were pleased with everything from the initial discussion with Alex to the final work done for us! Gabriel was knowledgeable and informative throughout the process! The hard working crew did an amazing job!" },
    { name: 'Michelle Usher', text: "Reliable Solutions team did a beautiful job at my house. They were at my house in a timely manner and stayed in contact with me. Great communication! I will refer them to anyone needing help with their crawlspace." },
  ]
